...
func TestPost(t *testing.T) {
	post := Post{
		...
		"title",
		"url",
		"https://img.reaction.pics/img/abcd.gif",
		123,
	}
	assert.Equal(t, post.ID, int64(1234))
	assert.Equal(t, post.Title, "title")
	assert.Equal(t, post.URL, "url")
	assert.Equal(t, post.Image, "https://img.reaction.pics/img/abcd.gif")
...
func TestInternalURL(t *testing.T) {
	post := Post{1, "title1", "url1", "https://img.reaction.pics/img/abcd.gif", 123}
	url := post.InternalURL()
	assert.Equal(t, url, "/post/1/title1")
}

func TestInternalURLLong(t *testing.T) {
	post := Post{1, strings.Repeat("a", 50), "url1", "https://img.reaction.pics/img/abcd.gif", 123}
	url := post.InternalURL()
...
func TestPostsToJSON(t *testing.T) {
	posts := make([]Post, 2)
	posts[0] = Post{1, "title1", "url1", "https://img.reaction.pics/img/abcd.gif", 123}
	posts[1] = Post{2, "title2", "url2", "https://img.reaction.pics/img/abcd.gif", 124}
...
func TestSortPostsByLikes(t *testing.T) {
	board := NewBoard([]Post{})
	board.AddPost(Post{3, "title3", "url3", "https://img.reaction.pics/img/abcd.gif", 123})
	board.AddPost(Post{1, "title1", "url1", "https://img.reaction.pics/img/abcd.gif", 121})
	board.AddPost(Post{2, "title2", "url2", "https://img.reaction.pics/img/abcd.gif", 122})
...
func TestKeywords(t *testing.T) {
	board := NewBoard([]Post{})
	board.AddPost(Post{3, "title2", "url3", "https://img.reaction.pics/img/abcd.gif", 123})
	board.AddPost(Post{1, "title1", "url1", "https://img.reaction.pics/img/abcd.gif", 121})
	board.AddPost(Post{2, "title1 title2 title2", "url2", "https://img.reaction.pics/img/abcd.gif", 122})
...
func TestKeywordsLong(t *testing.T) {
	...
	board.AddPost(Post{1, strings.Join(title, " "), "url1", "https://img.reaction.pics/img/abcd.gif", 121})
	keywords := board.Keywords()
